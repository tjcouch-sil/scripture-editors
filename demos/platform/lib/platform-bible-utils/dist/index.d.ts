 ...
 * @returns Function that unsubscribes from all passed in unsubscribers when run
 */
export declare const aggregateUnsubscriberAsyncs: (
 ...
 */
export declare function debounce<TFunc extends (...args: any[]) => any>(
  fn: TFunc,
  delay?: number,
...
export declare function groupBy<T, K, V>(
  items: T[],
 ...
 */
export declare function waitForDuration<TResult>(
  fn: () => Promise<TResult>,
 ...
 */
export declare function getAllObjectFunctionNames(
  obj: {
 ...
 */
export declare function createSyncProxyForAsyncObject<T extends object>(
 ...
 */
export declare function isErrorMessageAboutParatextBlockingInternetAccess(
 ...
 */
export declare const offsetChapter: (
 ...
 */
export declare const offsetVerse: (
  scrRef: SerializedVerseRef,
  offset: number,
) => SerializedVerseRef;
/**
 ...
 * @returns
 */
export declare function getLocalizedIdFromBookNumber(
  bookNumber: number,
 ...
 */
export declare function compareScrRefs(
...
export declare function getLocalizeKeyForScrollGroupId(
 ...
 */
export declare function getLocalizeKeysForScrollGroupIds(
  scrollGroupIds: (ScrollGroupId | undefined)[],
): `%${string}%`[];
/**
 ...
 */
export declare function formatScrRef(
  scrRef: SerializedVerseRef,
 ...
 * are shallow equaled.
 */
export declare function areUsjContentsEqualExceptWhitespace(
  a: Usj | undefined,
  b: Usj | undefined,
): boolean;
 ...
 */
export declare function formatReplacementStringToArray<T = unknown>(
  str: string,
  replacers:
    | {
        [key: string | number]: T;
 ...
 */
export declare function formatReplacementString(
  str: string,
  replacers:
    | {
 ...
 */
export declare function ordinalCompare(
  string1: string,
  string2: string,
 ...
 */
export declare function transformAndEnsureRegExpRegExpArray(
 ...
 */
export declare function transformAndEnsureRegExpArray(
 ...
 */
export declare function expandThemeContribution(
 ...
 * @returns
 */
export declare function applyThemeStylesheet(
  this: Window,
